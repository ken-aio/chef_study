...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "suguru-starter"
  ...
  #   chef.chef_server_url = "https://ip-10-152-150-67.ap-northeast-1.compute.internal/organizations/suguru"
  #   chef.validation_client_name = "suguru-validator"
  #   chef.validation_key_path = ".chef/suguru-validator.pem"
  # end
end
